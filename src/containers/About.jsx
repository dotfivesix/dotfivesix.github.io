    ...
    return (
      <section id="about" className="flex justify-center bg-white py-20">
        <div className="max-w-7xl px-8 md:px-12 flex flex-col gap-10">
          ...
          <AboutReading illustration="/images/illustrations/about-1.svg" alignment="left" alt="about-me-illustration" heading="About Me" paragraph="Hi there! My name is Ali and I am a self-taught Frontend developer with a passion for building visually stunning and user-friendly web applications. I have a strong foundation in HTML, CSS, and JavaScript, and have extensive experience working with ReactJS and NextJS to create efficient and scalable web applications. I am constantly learning and staying up to date with the latest web development technologies and methodologies, building personal projects in my free time to continue honing my skills. In my career, I am always looking for new opportunities to grow and improve my skills.." />
